                            ...
                            <tbody>
                                ...
                                @foreach ($pasien as $item)
                                    ...
                                    <tr
                                        ...
                                        <td class="text-left px-6 py-3 uppercase text-xs font-semibold text-slate text-slate-400">
                                            <input type="hidden" id="hid" value="{{$item->id}}" name="hid">
                                                <select id="status" name="status" class="bg-red-500 text-white uppercase border border-gray-300 text-slate text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">

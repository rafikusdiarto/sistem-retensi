    ...
    <div>
        <div>
            ...
            <p style="line-height: 1.5;text-align: justify;">
                Pada______________ telah dilakukan retensi berkas rekam medis, dengan persyaratan pasien dengan berkas yang diiretensi tidak pernah datang lagi berobat di Rumah Sakit Tingkat III  Baladhika Husada Jember selama lima tahun pada tahun {{$tahun}}, berikut jumlah rekam medis yang akan diretensi:
            </p>
        </div>
    </div>
    <div>
        <table style="width: 100%;border: 1px solid black;border-collapse: collapse;">
            <thead style="background-color: #72B854;">
                <tr>
                    ...
                    <th style="padding: 2px;border: 1px solid black;border-collapse: collapse">Status</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 2px;border: 1px solid black;border-collapse: collapse;text-transform:uppercase">{{$item->status}}</td>
                </tr>
                @endforeach
                <tr>
                    <th colspan="8" style="padding: 2px;border: 1px solid black;border-collapse: collapse">TOTAL</th>

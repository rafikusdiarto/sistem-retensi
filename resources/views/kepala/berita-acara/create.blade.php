...
@section('content')
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
            ...
            @endif
            <div
                class="container relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border">
                ...
                <form action="{{ url('/kepala/berita-acara/store') }}" method="POST" enctype="multipart/form-data"
                    class="p-[30px]">
                    @csrf
                    <div class="flex grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nip_petugas" id="nip_petugas"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('nip_petugas')
                                    <span class="pl-1 text-xs text-red-600 text-bold">
                                        {{ $message }}
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                <label for="nip_ketua_rm" class="block mb-2 text-sm font-medium text-slate text-slate">NIP Ketua
                                    Rekam Medis</label>
                                <input type="text" name="nip_ketua_rm" id="nip_ketua_rm"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('nip_ketua_rm')
                                    <small class="text-rose-600">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="direktur" id="direktur"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('direktur')
                                    <span class="pl-1 text-xs text-red-600 text-bold">
                                        {{ $message }}
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nip_direktur" id="nip_direktur"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('nip_direktur')
                                    <span class="pl-1 text-xs text-red-600 text-bold">
                                        {{ $message }}
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="no_surat" id="caraPemusnahan"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('no_surat')
                                    <small class="text-rose-600">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="rentang_tahun" id="caraPemusnahan"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('rentang_tahun')
                                    <small class="text-rose-600">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="jumlah_rm" id="caraPemusnahan"
                                    class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none">
                                @error('jumlah_rm')
                                    <small class="text-rose-600">{{ $message }}</small>
                                @enderror
